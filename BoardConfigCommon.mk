...
BOARD_KERNEL_IMAGE_NAME := Image-$(TARGET_DEVICE)

TARGET_NO_KERNEL_OVERRIDE := true
TARGET_KERNEL_SOURCE := $(KERNEL_PATH)/kernel-headers/$(TARGET_DEVICE)

BOARD_INCLUDE_DTB_IN_BOOTIMG := true
BOARD_PREBUILT_DTBOIMAGE := $(KERNEL_PATH)/dtbo/dtbo-$(TARGET_DEVICE).img
BOARD_PREBUILT_DTBIMAGE_DIR := $(KERNEL_PATH)/dtb/$(TARGET_DEVICE)
